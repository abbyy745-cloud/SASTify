            ...
            "runs": [{
                "tool": {
                    "driver": {
                        "name": "SASTify",
                        "version": "1.0.0",
                        "informationUri": "https://github.com/SASTify/sastify-vscode"
                    }
                },
...
<body>
    ...
    private _getHtmlForWebview(sr: any): string {
        ...
        const script = `
            ...
            // Severity filter
            function filterBySeverity(chip, severity) {
            ...
            window.addEventListener('message', function(event) {
                ...
                if (msg.command === 'aiAnalysisResult') {
                    ...
                    if (a.error) {
                        container.innerHTML = '<div class="ai-analysis" style="border-color: var(--critical);"><p style="color: var(--critical);">Error: ' + _esc(a.error) + '</p></div>';
                        return;
                    }
                    ...
                    if (!a.is_confirmed) {
                        ...
                        html += '<p>' + _esc(a.explanation || 'AI analysis suggests this is likely safe.') + '</p>';
                        html += '</div></div>';
                    } else {
                        ...
                        html += '<p>' + _esc(a.explanation || '') + '</p>';

                        if (a.suggested_fix) {
                            html += '<div class="ai-fix"><strong>Suggested Fix:</strong><pre>' + _esc(a.suggested_fix) + '</pre></div>';
                    ...
                    container.innerHTML =
                        ...
                        '<p style="color: var(--critical);">⚠ AI Error: ' + _esc(errMsg) + '</p>' +
                        retryBtn + '</div>';
    ...
    <div class="container">
        ...
        <div class="controls">
            ...
            <div class="filter-chips">
                <span class="chip active" onclick="filterBySeverity(this, 'all')">All</span>
                <span class="chip" onclick="filterBySeverity(this, 'critical')">Critical</span>
                <span class="chip" onclick="filterBySeverity(this, 'high')">High</span>
                <span class="chip" onclick="filterBySeverity(this, 'medium')">Medium</span>
                <span class="chip" onclick="filterBySeverity(this, 'low')">Low</span>
            </div>
        </div>
